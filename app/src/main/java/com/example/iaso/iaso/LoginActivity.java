...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //return the list of medicine objects from API?
            //call to MedicineListTask??
            //send the response as part of the Intent???
            Intent intent =  new Intent(LoginActivity.this, UserAccountHome.class);
            intent.putExtra("Success", email);
